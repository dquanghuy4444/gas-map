(function(factory) {
    ...
    providers['OpenStreetMap_Mapnik'] = {
        title: 'osm',
        icon: '../Images/IconLayer/openstreetmap_mapnik.png',
    ...
    //    title: 'osm bw',
    //    icon: '../Images/IconLayer/openstreetmap_blackandwhite.png',
    ...
    providers['OpenStreetMap_DE'] = {
        title: 'osm de',
        icon: '../Images/IconLayer/openstreetmap_de.png',
    ...
    //    title: 'toner',
    //    icon: '../Images/IconLayer/stamen_toner.png',
    ...
    //    title: 'esri ocean',
    //    icon: '../Images/IconLayer/esri_oceanbasemap.png',
    ...
    //    title: 'normalday',
    //    icon: '../Images/IconLayer/here_normalday.png',
    ...
    //    icon: '../Images/IconLayer/here_normaldaygrey.png',
    ...
    //    title: 'satellite',
    //    icon: '../Images/IconLayer/here_satelliteday.png',
    ...
    //    title: 'positron',
    //    icon: '../Images/IconLayer/cartodb_positron.png',
